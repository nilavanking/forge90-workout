...
const assets=['index.html','styles.css','app.js','forge90-base-app.js','forge90-session-controls.js','forge90-storage.js','forge90-enhancements.js','forge90-weight.js','forge90-conditioning-core.js','forge90-progression-core.js','forge90-conditioning.js','sw.js','manifest.webmanifest','_redirects','vendor/dexie.min.js','vendor/DEXIE-LICENSE.txt','icons/icon-192.png','icons/icon-512.png','icons/forge90-logo.png'];
const manifest={};
