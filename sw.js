...
const CACHE='forge90-v20260902-phase1-1';
const ASSETS=['./','./index.html','./styles.css','./app.js','./vendor/dexie.min.js','./forge90-storage.js','./forge90-base-app.js','./forge90-timers.js','./forge90-enhancements.js','./manifest.webmanifest','./icons/forge90-logo.png','./icons/icon-192.png','./icons/icon-512.png'];
