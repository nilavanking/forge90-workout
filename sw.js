...
const CACHE='forge90-v20260913-v1-corrections-1';
const ASSETS=['./','./index.html','./styles.css','./app.js','./vendor/dexie.min.js','./forge90-storage.js','./forge90-base-app.js','./forge90-session-controls.js','./forge90-enhancements.js','./forge90-weight.js','./forge90-conditioning-core.js','./forge90-measurements.js','./forge90-progression-core.js','./forge90-conditioning.js','./manifest.webmanifest','./icons/forge90-logo.png','./icons/icon-192.png','./icons/icon-512.png'];
